...
const CLIPPY_SOLUTIONS = {
  ...
  frag2: { subtitle:"Workbench-Struktur für Fragment #2 bauen.", steps:[ 'Gehe in dein Home: <code>cd /home/player</code> (oder nutze direkt immer Pfade mit <code>~/...</code>).', 'Erstelle die Zielstruktur robust mit Home-Pfaden: <code>mkdir ~/workbench</code> und danach <code>mkdir ~/workbench/patches</code>.', 'Lege die Quest-Datei an: <code>touch ~/workbench/patches/frag2.txt</code>.', 'Wichtig für den Abschluss: lies die Datei anschließend explizit mit <code>cat ~/workbench/patches/frag2.txt</code>. Erst dann wird FRAG2 gesetzt; prüfe danach mit <code>quests</code>.' ], hint:'Erklärung: Bei Frag2 reicht touch allein nicht – der Trigger passiert beim cat auf frag2.txt.' },
